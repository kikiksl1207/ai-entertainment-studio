...
const I18N_DICT = {
  ...
  "account.guidance.heading": { "ko-KR": "계정 안내", "ja-JP": "アカウント案内", "en-US": "Account guide", "zh-CN": "账号说明", "zh-Hant": "帳號說明" },
  "account.guidance.member": { "ko-KR": "루미나 멤버", "ja-JP": "Lumina メンバー", "en-US": "Lumina member", "zh-CN": "Lumina 会员", "zh-Hant": "Lumina 會員" },
  "account.guidance.publicAccount": { "ko-KR": "공개 계정", "ja-JP": "公開アカウント", "en-US": "Public account", "zh-CN": "公开账号", "zh-Hant": "公開帳號" },
  "account.guidance.emailPrivate": { "ko-KR": "이메일 비공개", "ja-JP": "メールは非公開", "en-US": "Email hidden", "zh-CN": "邮箱不公开", "zh-Hant": "信箱不公開" },
  "account.guidance.emailVerified": { "ko-KR": "인증 완료", "ja-JP": "認証済み", "en-US": "Verified", "zh-CN": "已验证", "zh-Hant": "已驗證" },
  "account.guidance.emailRequired": { "ko-KR": "인증 필요", "ja-JP": "認証が必要", "en-US": "Verification needed", "zh-CN": "需要验证", "zh-Hant": "需要驗證" },
  "account.guidance.passwordSocial": { "ko-KR": "소셜 계정에서 관리", "ja-JP": "ソーシャルアカウントで管理", "en-US": "Managed with social sign-in", "zh-CN": "由社交账号管理", "zh-Hant": "由社群帳號管理" },
  "account.guidance.passwordReady": { "ko-KR": "설정 완료", "ja-JP": "設定済み", "en-US": "Set", "zh-CN": "已设置", "zh-Hant": "已設定" },
  "account.guidance.passwordRequired": { "ko-KR": "설정 필요", "ja-JP": "設定が必要", "en-US": "Setup needed", "zh-CN": "需要设置", "zh-Hant": "需要設定" },
  "account.guidance.identity": { "ko-KR": "본인확인", "ja-JP": "本人確認", "en-US": "Identity verification", "zh-CN": "身份验证", "zh-Hant": "身分驗證" },
  "account.guidance.identityNone": { "ko-KR": "추가 확인 없음", "ja-JP": "追加確認なし", "en-US": "No additional verification", "zh-CN": "无需额外验证", "zh-Hant": "無需額外驗證" },
  "account.guidance.identityPending": { "ko-KR": "본인확인 진행 중", "ja-JP": "本人確認中", "en-US": "Identity verification in progress", "zh-CN": "身份验证进行中", "zh-Hant": "身分驗證進行中" },
  "account.guidance.fixture.verified.title": { "ko-KR": "계정 확인이 완료되었습니다", "ja-JP": "アカウントの確認が完了しました", "en-US": "Your account is ready", "zh-CN": "账号已准备就绪", "zh-Hant": "帳號已準備就緒" },
  "account.guidance.fixture.verified.body": { "ko-KR": "이메일과 비밀번호 설정이 완료되었습니다.", "ja-JP": "メール認証とパスワード設定が完了しています。", "en-US": "Your email and password are set.", "zh-CN": "邮箱验证和密码设置已完成。", "zh-Hant": "信箱驗證和密碼設定已完成。" },
  "account.guidance.fixture.unverified.title": { "ko-KR": "이메일 인증이 필요합니다", "ja-JP": "メール認証が必要です", "en-US": "Verify your email", "zh-CN": "需要验证邮箱", "zh-Hant": "需要驗證信箱" },
  "account.guidance.fixture.unverified.body": { "ko-KR": "이메일 인증을 마치면 계정 기능을 이용할 수 있습니다.", "ja-JP": "メール認証を完了するとアカウント機能を利用できます。", "en-US": "Verify your email to use account features.", "zh-CN": "完成邮箱验证后即可使用账号功能。", "zh-Hant": "完成信箱驗證後即可使用帳號功能。" },
  "account.guidance.fixture.social.title": { "ko-KR": "소셜 로그인 계정", "ja-JP": "ソーシャルログインのアカウント", "en-US": "Social sign-in account", "zh-CN": "社交登录账号", "zh-Hant": "社群登入帳號" },
  "account.guidance.fixture.social.body": { "ko-KR": "비밀번호는 연결한 소셜 계정에서 관리할 수 있습니다.", "ja-JP": "パスワードは連携したソーシャルアカウントで管理できます。", "en-US": "Manage your password with the connected social account.", "zh-CN": "可通过已关联的社交账号管理密码。", "zh-Hant": "可透過已連結的社群帳號管理密碼。" },
  "account.guidance.fixture.noPassword.title": { "ko-KR": "비밀번호 설정이 필요합니다", "ja-JP": "パスワード設定が必要です", "en-US": "Set a password", "zh-CN": "需要设置密码", "zh-Hant": "需要設定密碼" },
  "account.guidance.fixture.noPassword.body": { "ko-KR": "비밀번호를 설정하면 이메일 로그인도 이용할 수 있습니다.", "ja-JP": "パスワードを設定するとメールログインも利用できます。", "en-US": "Set a password to also sign in with email.", "zh-CN": "设置密码后也可使用邮箱登录。", "zh-Hant": "設定密碼後也可使用信箱登入。" },
  "account.guidance.fixture.identityPending.title": { "ko-KR": "본인확인이 진행 중입니다", "ja-JP": "本人確認を進めています", "en-US": "Identity verification is in progress", "zh-CN": "身份验证正在进行", "zh-Hant": "身分驗證正在進行" },
  "account.guidance.fixture.identityPending.body": { "ko-KR": "확인이 끝나면 필요한 기능을 이어서 이용할 수 있습니다.", "ja-JP": "確認が終わると必要な機能を続けて利用できます。", "en-US": "You can continue with eligible features once verification is complete.", "zh-CN": "验证完成后即可继续使用相关功能。", "zh-Hant": "驗證完成後即可繼續使用相關功能。" },
  "account.guidance.emailCard.verified.title": { "ko-KR": "이메일 인증이 완료되었습니다", "ja-JP": "メール認証が完了しました", "en-US": "Your email is verified", "zh-CN": "邮箱已验证", "zh-Hant": "信箱已驗證" },
  "account.guidance.emailCard.verified.body": { "ko-KR": "개인 이메일 주소는 보호됩니다.", "ja-JP": "メールアドレスは保護されています。", "en-US": "Your email address remains protected.", "zh-CN": "你的邮箱地址会受到保护。", "zh-Hant": "你的信箱地址會受到保護。" },
  "account.guidance.emailCard.required.title": { "ko-KR": "이메일 인증이 필요합니다", "ja-JP": "メール認証が必要です", "en-US": "Email verification is needed", "zh-CN": "需要邮箱验证", "zh-Hant": "需要信箱驗證" },
  "account.guidance.emailCard.required.body": { "ko-KR": "받은편지함을 확인하거나 인증 메일을 다시 요청해 주세요.", "ja-JP": "受信箱を確認するか、認証メールを再度リクエストしてください。", "en-US": "Check your inbox or request another verification email.", "zh-CN": "请查看收件箱或重新请求验证邮件。", "zh-Hant": "請查看收件匣或重新請求驗證信。" },
  "account.guidance.emailCard.note": { "ko-KR": "이메일 인증은 계정 설정에서 진행할 수 있습니다.", "ja-JP": "メール認証はアカウント設定から進められます。", "en-US": "You can complete email verification in account settings.", "zh-CN": "可在账号设置中完成邮箱验证。", "zh-Hant": "可在帳號設定中完成信箱驗證。" },
  "account.guidance.action.continue": { "ko-KR": "계속 이용", "ja-JP": "続ける", "en-US": "Continue", "zh-CN": "继续使用", "zh-Hant": "繼續使用" },
  "account.guidance.action.verifyEmail": { "ko-KR": "이메일 인증", "ja-JP": "メール認証", "en-US": "Verify email", "zh-CN": "验证邮箱", "zh-Hant": "驗證信箱" },
  "account.guidance.action.manageSocial": { "ko-KR": "소셜 계정에서 관리", "ja-JP": "ソーシャルアカウントで管理", "en-US": "Manage with social sign-in", "zh-CN": "在社交账号中管理", "zh-Hant": "在社群帳號中管理" },
  "account.guidance.action.setPassword": { "ko-KR": "비밀번호 설정", "ja-JP": "パスワード設定", "en-US": "Set password", "zh-CN": "设置密码", "zh-Hant": "設定密碼" },
  "account.guidance.action.reviewIdentity": { "ko-KR": "본인확인 안내", "ja-JP": "本人確認の案内", "en-US": "Identity verification details", "zh-CN": "身份验证说明", "zh-Hant": "身分驗證說明" },
  "creatorStudio.gate.requested.title": { "ko-KR": "요청됨 · 승인 필요", "ja-JP": "申請済み・承認待ち", "en-US": "Requested · Approval needed", "zh-CN": "已申请 · 等待批准", "zh-Hant": "已申請 · 等待核准" },
  "creatorStudio.gate.requested.body": { "ko-KR": "요청 내용은 확인 절차를 거쳐 처리됩니다.", "ja-JP": "申請内容は確認手続きを経て処理されます。", "en-US": "Your request is processed after review.", "zh-CN": "申请内容会在确认后处理。", "zh-Hant": "申請內容會在確認後處理。" },
  "creatorStudio.gate.approved.title": { "ko-KR": "승인됨 · 지갑 반영 대기", "ja-JP": "承認済み・ウォレット反映待ち", "en-US": "Approved · Wallet update pending", "zh-CN": "已批准 · 等待钱包更新", "zh-Hant": "已核准 · 等待錢包更新" },
  "creatorStudio.gate.approved.body": { "ko-KR": "승인 후 반영 시점을 안내해 드립니다.", "ja-JP": "承認後に反映時期をご案内します。", "en-US": "We will let you know when the update is reflected.", "zh-CN": "更新生效后会通知你。", "zh-Hant": "更新生效後會通知你。" },
  "creatorStudio.gate.safe.title": { "ko-KR": "안전한 처리", "ja-JP": "安全な処理", "en-US": "Secure handling", "zh-CN": "安全处理", "zh-Hant": "安全處理" },
  "creatorStudio.gate.safe.body": { "ko-KR": "필요한 정보를 확인한 뒤 안전하게 처리합니다.", "ja-JP": "必要な情報を確認して安全に処理します。", "en-US": "We confirm the required details before processing securely.", "zh-CN": "确认必要信息后会安全处理。", "zh-Hant": "確認必要資訊後會安全處理。" },
  // ── 헤더 auth ──
  ...
  "writerManuscript.kicker": { "ko-KR": "MY STORY", "ja-JP": "MY STORY", "en-US": "MY STORY", "zh-CN": "MY STORY", "zh-Hant": "MY STORY" },
  "writerManuscript.heading": { "ko-KR": "내 작품 원고 준비", "ja-JP": "自分の作品の原稿準備", "en-US": "Prepare my manuscript", "zh-CN": "准备我的作品稿件", "zh-Hant": "準備我的作品稿件" },
  "writerManuscript.badge": { "ko-KR": "전송 전 검토", "ja-JP": "送信前の確認", "en-US": "Review before sending", "zh-CN": "提交前核对", "zh-Hant": "提交前核對" },
  "writerManuscript.privacy": { "ko-KR": "제출 전에는 이 브라우저에서만 검토합니다. 원고는 비공개로 접수되며 분석은 직접 시작할 때만 요청됩니다. 원고가 공개되지는 않습니다.", "ja-JP": "送信前はこのブラウザー内だけで確認します。原稿は非公開で受け付け、分析は自分で開始したときだけ依頼されます。原稿は公開されません。", "en-US": "Review stays in this browser until submission. Manuscripts are received privately. Analysis starts only at your request; it does not publish your manuscript.", "zh-CN": "提交前仅在此浏览器中核对。稿件以非公开方式接收，只有你主动开始时才会请求分析。稿件不会被发布。", "zh-Hant": "提交前僅在此瀏覽器中核對。稿件以非公開方式接收，只有你主動開始時才會請求分析。稿件不會被發布。" },
  "writerManuscript.work": { "ko-KR": "내 작품", "ja-JP": "自分の作品", "en-US": "My work", "zh-CN": "我的作品", "zh-Hant": "我的作品" },
  "writerManuscript.locale": { "ko-KR": "원문 언어", "ja-JP": "原文の言語", "en-US": "Source language", "zh-CN": "原文语言", "zh-Hant": "原文語言" },
  "writerManuscript.file": { "ko-KR": "텍스트 파일", "ja-JP": "テキストファイル", "en-US": "Text file", "zh-CN": "文本文件", "zh-Hant": "文字檔案" },
  "writerManuscript.fileHelp": { "ko-KR": "UTF-8 TXT/MD · 최대 16 MiB · DOCX/HWP는 내용을 복사해 아래에 붙여넣으세요.", "ja-JP": "UTF-8 TXT/MD · 最大16 MiB · DOCX/HWPは本文をコピーして下に貼り付けてください。", "en-US": "UTF-8 TXT/MD · 16 MiB max · For DOCX/HWP, copy the text and paste it below.", "zh-CN": "UTF-8 TXT/MD · 最大16 MiB · DOCX/HWP请复制正文并粘贴在下方。", "zh-Hant": "UTF-8 TXT/MD · 最大16 MiB · DOCX/HWP請複製正文並貼在下方。" },
  "writerManuscript.body": { "ko-KR": "원고 본문", "ja-JP": "原稿本文", "en-US": "Manuscript text", "zh-CN": "稿件正文", "zh-Hant": "稿件正文" },
  "writerManuscript.placeholder": { "ko-KR": "Word 또는 한글에서 복사한 원고를 붙여넣으세요.", "ja-JP": "Wordやハングルからコピーした原稿を貼り付けてください。", "en-US": "Paste manuscript text copied from Word or Hangul.", "zh-CN": "粘贴从 Word 或韩文软件复制的稿件正文。", "zh-Hant": "貼上從 Word 或韓文軟體複製的稿件正文。" },
  ...
  "writerManuscript.removePart": { "ko-KR": "경계 삭제", "ja-JP": "境界を削除", "en-US": "Remove boundary", "zh-CN": "删除边界", "zh-Hant": "刪除邊界" },
  "writerManuscript.partTitle": { "ko-KR": "파트 제목", "ja-JP": "パート名", "en-US": "Part title", "zh-CN": "部分标题", "zh-Hant": "部分標題" },
  ...
  "writerManuscript.tooLarge": { "ko-KR": "원고가 16 MiB를 넘습니다. 이 화면에서는 더 큰 입력을 검토할 수 없습니다.", "ja-JP": "原稿が16 MiBを超えています。この画面では確認できません。", "en-US": "The manuscript exceeds 16 MiB and cannot be reviewed here.", "zh-CN": "稿件超过16 MiB，无法在此核对。", "zh-Hant": "稿件超過16 MiB，無法在此核對。" },
  "writerManuscript.fileType": { "ko-KR": "UTF-8 TXT 또는 MD 파일만 선택해 주세요.", "ja-JP": "UTF-8のTXTまたはMDファイルを選択してください。", "en-US": "Choose a UTF-8 TXT or MD file.", "zh-CN": "请选择 UTF-8 TXT 或 MD 文件。", "zh-Hant": "請選擇 UTF-8 TXT 或 MD 檔案。" },
  "writerManuscript.invalidUtf8": { "ko-KR": "파일을 UTF-8 텍스트로 읽을 수 없습니다. 원문 인코딩을 확인해 주세요.", "ja-JP": "UTF-8テキストとして読み取れません。文字コードを確認してください。", "en-US": "The file is not valid UTF-8 text. Check its encoding.", "zh-CN": "无法按 UTF-8 文本读取，请检查编码。", "zh-Hant": "無法以 UTF-8 文字讀取，請檢查編碼。" },
  "writerManuscript.lineEndings": { "ko-KR": "파일 줄바꿈을 이 편집기에서 그대로 보존할 수 없어 검토를 중단했습니다. 원본 파일은 변경되지 않았습니다.", "ja-JP": "この編集欄ではファイルの改行をそのまま保持できないため、確認を中止しました。元のファイルは変更されていません。", "en-US": "This editor cannot preserve the file's line endings, so review stopped. The original file was not changed.", "zh-CN": "此编辑器无法原样保留文件换行，核对已停止。原文件未修改。", "zh-Hant": "此編輯器無法原樣保留檔案換行，核對已停止。原檔案未修改。" },
  "writerManuscript.invalidBoundary": { "ko-KR": "본문 중간의 새 파트 시작 위치에 커서를 놓아 주세요. 최대 1,000파트입니다.", "ja-JP": "本文中の新しいパート開始位置にカーソルを置いてください。最大1,000パートです。", "en-US": "Place the cursor at a new part start inside the text. Maximum 1,000 parts.", "zh-CN": "请将光标放在正文中的新部分起点，最多1,000部分。", "zh-Hant": "請將游標放在正文中的新部分起點，最多1,000部分。" },
  "writerManuscript.partMismatch": { "ko-KR": "현재 검토 구간 {count}개, 예상 파트 {expected}개입니다. 경계를 다시 확인해 주세요.", "ja-JP": "確認範囲は{count}件、予定パートは{expected}件です。境界を確認してください。", "en-US": "Found {count} review ranges; expected {expected} parts. Review the boundaries.", "zh-CN": "当前有{count}个核对区间，预计{expected}部分。请检查边界。", "zh-Hant": "目前有{count}個核對區間，預計{expected}部分。請檢查邊界。" },
  "writerManuscript.partIncomplete": { "ko-KR": "빈 파트나 제목이 있습니다. 모든 구간과 제목을 확인해 주세요.", "ja-JP": "空のパートまたはタイトルがあります。すべて確認してください。", "en-US": "A part or title is empty. Review every range and title.", "zh-CN": "存在空白部分或标题，请逐一核对。", "zh-Hant": "存在空白部分或標題，請逐一核對。" },
  ...
  "writerManuscript.boundariesReviewed": { "ko-KR": "파트 경계를 검토했습니다. 확인란을 선택해야 제출할 수 있습니다.", "ja-JP": "パート境界を確認しました。確認欄にチェックすると送信できます。", "en-US": "Part boundaries reviewed. Check the confirmation box to submit.", "zh-CN": "部分边界已核对。勾选确认框后才能提交。", "zh-Hant": "部分邊界已核對。勾選確認方塊後才能提交。" },
  "writerManuscript.boundary": { "ko-KR": "각 파트의 시작 위치와 제목을 확인해 주세요. 제출하면 원문과 확인한 경계가 비공개로 접수됩니다.", "ja-JP": "各パートの開始位置とタイトルを確認してください。送信すると原文と確認した境界を非公開で受け付けます。", "en-US": "Review each part start and title. Submission privately receives the exact text and confirmed boundaries.", "zh-CN": "请核对每部分的起点和标题。提交后原文和确认的边界将以非公开方式接收。", "zh-Hant": "請核對每部分的起點和標題。提交後原文及確認的邊界會以非公開方式接收。" },
  "writerManuscript.confirm": { "ko-KR": "원문과 모든 파트 경계를 검토했으며 이 작품에 비공개로 제출합니다.", "ja-JP": "原文とすべてのパート境界を確認し、この作品に非公開で送信します。", "en-US": "I reviewed the source and every part boundary and will submit them privately to this work.", "zh-CN": "我已核对原文和所有部分边界，并将其非公开提交到此作品。", "zh-Hant": "我已核對原文和所有部分邊界，並會將其非公開提交至此作品。" },
  "writerManuscript.submit": { "ko-KR": "원고 비공개 제출", "ja-JP": "原稿を非公開で送信", "en-US": "Submit manuscript privately", "zh-CN": "非公开提交稿件", "zh-Hant": "非公開提交稿件" },
  "writerManuscript.submitting": { "ko-KR": "원고를 비공개로 접수 요청 중입니다.", "ja-JP": "原稿を非公開で送信しています。", "en-US": "Submitting the manuscript privately.", "zh-CN": "正在非公开提交稿件。", "zh-Hant": "正在非公開提交稿件。" },
  "writerManuscript.authRequired": { "ko-KR": "로그인 상태를 확인한 뒤 다시 제출해 주세요.", "ja-JP": "ログイン状態を確認してから再送信してください。", "en-US": "Check your sign-in and try submitting again.", "zh-CN": "请确认登录状态后重试提交。", "zh-Hant": "請確認登入狀態後再提交。" },
  "writerManuscript.invalidUnicode": { "ko-KR": "원고 또는 파트 제목에 UTF-8로 보낼 수 없는 문자가 있습니다.", "ja-JP": "原稿またはパート名にUTF-8で送信できない文字があります。", "en-US": "The manuscript or a part title contains text that cannot be sent as UTF-8.", "zh-CN": "稿件或部分标题中有无法按 UTF-8 发送的字符。", "zh-Hant": "稿件或部分標題含有無法以 UTF-8 傳送的字元。" },
  "writerManuscript.reviewRequired": { "ko-KR": "현재 작품, 언어, 원문과 경계를 다시 검토하고 확인해 주세요.", "ja-JP": "現在の作品、言語、原文、境界を再確認してください。", "en-US": "Review and confirm the current work, language, source, and boundaries again.", "zh-CN": "请重新核对并确认当前作品、语言、原文和边界。", "zh-Hant": "請重新核對並確認目前作品、語言、原文及邊界。" },
  "writerManuscript.received": { "ko-KR": "비공개 원고 버전 {version} 접수 확인 · {count}파트 · {bytes}바이트. 분석은 시작되지 않았습니다.", "ja-JP": "非公開原稿のバージョン{version}を受け付けました · {count}パート · {bytes}バイト。分析は開始していません。", "en-US": "Private manuscript version {version} received · {count} parts · {bytes} bytes. Analysis has not started.", "zh-CN": "已接收非公开稿件版本 {version} · {count} 部分 · {bytes} 字节。尚未开始分析。", "zh-Hant": "已接收非公開稿件版本 {version} · {count} 部分 · {bytes} 位元組。尚未開始分析。" },
  "writerManuscript.receivedReplay": { "ko-KR": "기존 비공개 원고 버전 {version} 확인 · {count}파트 · {bytes}바이트. 새 분석은 시작되지 않았습니다.", "ja-JP": "既存の非公開原稿バージョン{version}を確認しました · {count}パート · {bytes}バイト。新しい分析は開始していません。", "en-US": "Existing private manuscript version {version} confirmed · {count} parts · {bytes} bytes. No new analysis started.", "zh-CN": "已确认现有非公开稿件版本 {version} · {count} 部分 · {bytes} 字节。未开始新的分析。", "zh-Hant": "已確認現有非公開稿件版本 {version} · {count} 部分 · {bytes} 位元組。未開始新的分析。" },
  "writerManuscript.rejected": { "ko-KR": "서버가 접수를 거절했습니다 (HTTP {status}). 경계와 권한을 확인한 뒤 다시 시도해 주세요.", "ja-JP": "サーバーが受付を拒否しました (HTTP {status})。境界と権限を確認して再試行してください。", "en-US": "The server rejected intake (HTTP {status}). Check boundaries and access, then retry.", "zh-CN": "服务器拒绝接收 (HTTP {status})。请检查边界和权限后重试。", "zh-Hant": "伺服器拒絕接收 (HTTP {status})。請檢查邊界及權限後重試。" },
  "writerManuscript.requestFailed": { "ko-KR": "서버 응답을 확인하지 못했습니다. 접수 여부를 확인한 뒤 다시 시도해 주세요.", "ja-JP": "サーバーの応答を確認できませんでした。受付状況を確認してから再試行してください。", "en-US": "Could not confirm the server response. Check intake status before retrying.", "zh-CN": "无法确认服务器响应。请核对接收状态后再重试。", "zh-Hant": "無法確認伺服器回應。請核對接收狀態後再重試。" },
  "writerManuscript.invalidReceipt": { "ko-KR": "서버 접수증을 확인할 수 없습니다. 접수 상태를 확인해 주세요.", "ja-JP": "サーバーの受付票を確認できません。受付状況を確認してください。", "en-US": "The server receipt could not be verified. Check intake status.", "zh-CN": "无法核实服务器接收凭据。请检查接收状态。", "zh-Hant": "無法核實伺服器接收憑據。請檢查接收狀態。" },
  "writerManuscript.nav": { "ko-KR": "내 작품 원고", "ja-JP": "自分の作品原稿", "en-US": "My manuscript", "zh-CN": "我的稿件", "zh-Hant": "我的稿件" },
  "writerAnalysis.title": { "ko-KR": "원고 분석", "ja-JP": "原稿の分析", "en-US": "Manuscript analysis", "zh-CN": "稿件分析", "zh-Hant": "稿件分析" },
  "writerAnalysis.savedManuscripts": { "ko-KR": "접수된 원고", "ja-JP": "受付済みの原稿", "en-US": "Received manuscripts", "zh-CN": "已接收的稿件", "zh-Hant": "已接收的稿件" },
  "writerAnalysis.manuscriptVersion": { "ko-KR": "원고 버전", "ja-JP": "原稿バージョン", "en-US": "Manuscript version", "zh-CN": "稿件版本", "zh-Hant": "稿件版本" },
  "writerAnalysis.existingAnalysis": { "ko-KR": "기존 분석", "ja-JP": "既存の分析", "en-US": "Existing analysis", "zh-CN": "已有分析", "zh-Hant": "既有分析" },
  "writerAnalysis.chooseVersion": { "ko-KR": "원고 버전 선택", "ja-JP": "原稿バージョンを選択", "en-US": "Select a manuscript version", "zh-CN": "选择稿件版本", "zh-Hant": "選擇稿件版本" },
  "writerAnalysis.chooseAnalysis": { "ko-KR": "기존 분석 선택", "ja-JP": "既存の分析を選択", "en-US": "Select an existing analysis", "zh-CN": "选择已有分析", "zh-Hant": "選擇既有分析" },
  "writerAnalysis.noVersions": { "ko-KR": "이 작품에 접수된 원고가 없습니다.", "ja-JP": "この作品の受付済み原稿はありません。", "en-US": "No manuscripts have been received for this work.", "zh-CN": "此作品尚无已接收的稿件。", "zh-Hant": "此作品尚無已接收的稿件。" },
  "writerAnalysis.noAnalyses": { "ko-KR": "이 원고 버전에는 기존 분석이 없습니다.", "ja-JP": "この原稿バージョンには既存の分析がありません。", "en-US": "This manuscript version has no existing analyses.", "zh-CN": "此稿件版本没有已有分析。", "zh-Hant": "此稿件版本沒有既有分析。" },
  "writerAnalysis.analysisOption": { "ko-KR": "분석 {version} · {status}", "ja-JP": "分析 {version} · {status}", "en-US": "Analysis {version} · {status}", "zh-CN": "分析 {version} · {status}", "zh-Hant": "分析 {version} · {status}" },
  "writerAnalysis.jobrunning": { "ko-KR": "분석 중", "ja-JP": "分析中", "en-US": "In progress", "zh-CN": "分析中", "zh-Hant": "分析中" },
  "writerAnalysis.jobqueued": { "ko-KR": "대기 중", "ja-JP": "待機中", "en-US": "Queued", "zh-CN": "排队中", "zh-Hant": "排隊中" },
  "writerAnalysis.jobcompleted": { "ko-KR": "분석 종료", "ja-JP": "分析終了", "en-US": "Finished", "zh-CN": "分析结束", "zh-Hant": "分析結束" },
  "writerAnalysis.jobfailed": { "ko-KR": "중단됨", "ja-JP": "停止", "en-US": "Stopped", "zh-CN": "已停止", "zh-Hant": "已停止" },
  "writerAnalysis.start": { "ko-KR": "분석 시작", "ja-JP": "分析を開始", "en-US": "Start analysis", "zh-CN": "开始分析", "zh-Hant": "開始分析" },
  "writerAnalysis.check": { "ko-KR": "상태 다시 확인", "ja-JP": "状態を再確認", "en-US": "Check status", "zh-CN": "重新查看状态", "zh-Hant": "重新查看狀態" },
  "writerAnalysis.checkRequest": { "ko-KR": "기존 요청 다시 확인", "ja-JP": "送信済みの依頼を確認", "en-US": "Check original request", "zh-CN": "核对原有请求", "zh-Hant": "核對原有請求" },
  "writerAnalysis.boundary": { "ko-KR": "분석 결과는 검토가 필요한 제안이며 작가의 승인이나 공개를 뜻하지 않습니다.", "ja-JP": "分析結果は確認が必要な提案です。作者の承認や公開を意味するものではありません。", "en-US": "Analysis results are suggestions to review, not writer approval or publication.", "zh-CN": "分析结果是待核对的建议，并不代表作者批准或发布。", "zh-Hant": "分析結果是待核對的建議，並不代表作者批准或發布。" },
  "writerAnalysis.ready": { "ko-KR": "접수된 이 원고 버전의 분석을 시작할 수 있습니다.", "ja-JP": "受け付けたこの原稿バージョンの分析を開始できます。", "en-US": "This received manuscript version is ready for an analysis request.", "zh-CN": "可以为已接收的此稿件版本请求分析。", "zh-Hant": "可以為已接收的此稿件版本請求分析。" },
  "writerAnalysis.loading": { "ko-KR": "확인하고 있습니다.", "ja-JP": "確認しています。", "en-US": "Checking.", "zh-CN": "正在核对。", "zh-Hant": "正在核對。" },
  "writerAnalysis.starting": { "ko-KR": "분석 요청을 접수하고 있습니다.", "ja-JP": "分析を依頼しています。", "en-US": "Submitting your analysis request.", "zh-CN": "正在提交分析请求。", "zh-Hant": "正在提交分析請求。" },
  "writerAnalysis.unknown": { "ko-KR": "요청 결과를 아직 확인하지 못했습니다. 기존 요청을 다시 확인할 수 있습니다.", "ja-JP": "依頼の結果をまだ確認できません。送信済みの依頼を再確認できます。", "en-US": "The request outcome is not yet confirmed. You can check the original request again.", "zh-CN": "尚未确认请求结果。可以再次核对原有请求。", "zh-Hant": "尚未確認請求結果。可以再次核對原有請求。" },
  "writerAnalysis.reserved": { "ko-KR": "이 원고 버전에는 이미 분석 요청이 있습니다. 접수된 원고에서 기존 분석을 확인해 주세요. 원고를 다시 제출할 필요는 없습니다.", "ja-JP": "この原稿バージョンには既に分析の依頼があります。受付済みの原稿から既存の分析を確認してください。原稿の再送信は不要です。", "en-US": "This manuscript version already has an analysis request. Check its existing analysis under Received manuscripts; you do not need to resubmit it.", "zh-CN": "此稿件版本已有分析请求。请在已接收的稿件中查看已有分析，无需重新提交稿件。", "zh-Hant": "此稿件版本已有分析請求。請在已接收的稿件中查看既有分析，無需重新提交稿件。" },
  "writerAnalysis.unavailable": { "ko-KR": "지금은 분석을 시작할 수 없습니다. 원고는 비공개로 접수되어 있습니다.", "ja-JP": "現在は分析を開始できません。原稿は非公開で受け付けています。", "en-US": "Analysis cannot start right now. Your manuscript has been received privately.", "zh-CN": "暂时无法开始分析。稿件已以非公开方式接收。", "zh-Hant": "暫時無法開始分析。稿件已以非公開方式接收。" },
  "writerAnalysis.storageUnavailable": { "ko-KR": "이 브라우저에 요청 정보를 보관할 수 없어 이번 시도는 전송하지 않았습니다.", "ja-JP": "このブラウザーに依頼情報を保持できないため、今回は送信していません。", "en-US": "This attempt was not sent because the browser could not retain the request details.", "zh-CN": "此浏览器无法保留请求信息，因此本次未发送请求。", "zh-Hant": "此瀏覽器無法保留請求資訊，因此本次未傳送請求。" },
  "writerAnalysis.queued": { "ko-KR": "분석 순서를 기다리고 있습니다.", "ja-JP": "分析の順番を待っています。", "en-US": "Waiting for analysis to begin.", "zh-CN": "正在等待分析。", "zh-Hant": "正在等待分析。" },
  "writerAnalysis.planning": { "ko-KR": "원고의 분석 범위를 확인하고 있습니다.", "ja-JP": "原稿の分析範囲を確認しています。", "en-US": "Checking manuscript coverage.", "zh-CN": "正在核对稿件分析范围。", "zh-Hant": "正在核對稿件分析範圍。" },
  "writerAnalysis.extracting": { "ko-KR": "원고를 분석하고 있습니다.", "ja-JP": "原稿を分析しています。", "en-US": "Analyzing the manuscript.", "zh-CN": "正在分析稿件。", "zh-Hant": "正在分析稿件。" },
  "writerAnalysis.finalizing": { "ko-KR": "분석 결과를 정리하고 있습니다.", "ja-JP": "分析結果を整理しています。", "en-US": "Organizing the analysis results.", "zh-CN": "正在整理分析结果。", "zh-Hant": "正在整理分析結果。" },
  "writerAnalysis.completed": { "ko-KR": "전체 원고의 분석이 끝났습니다. 결과와 인용 원문을 검토해 주세요.", "ja-JP": "原稿全体の分析が完了しました。結果と引用元を確認してください。", "en-US": "Analysis covers the complete manuscript. Review the results and their source quotations.", "zh-CN": "整个稿件已完成分析。请核对结果及其原文引用。", "zh-Hant": "整個稿件已完成分析。請核對結果及其原文引用。" },
  "writerAnalysis.incomplete": { "ko-KR": "전체 원고가 분석되었는지 확인할 수 없습니다. 현재 결과를 전체 분석으로 간주하지 마세요.", "ja-JP": "原稿全体が分析されたか確認できません。現在の結果を全体の分析として扱わないでください。", "en-US": "Full manuscript coverage is not confirmed. These results should not be treated as a complete analysis.", "zh-CN": "无法确认是否已分析整个稿件。请勿将当前结果视为完整分析。", "zh-Hant": "無法確認是否已分析整個稿件。請勿將目前結果視為完整分析。" },
  "writerAnalysis.failed": { "ko-KR": "분석이 중단되었습니다. 남아 있는 결과를 확인할 수 있으며 새 분석은 자동으로 요청되지 않습니다.", "ja-JP": "分析が停止しました。残っている結果は確認できます。新しい分析が自動で依頼されることはありません。", "en-US": "Analysis stopped. Available results can still be reviewed; no new analysis is requested automatically.", "zh-CN": "分析已停止。仍可查看已有结果，系统不会自动请求新的分析。", "zh-Hant": "分析已停止。仍可查看已有結果，系統不會自動請求新的分析。" },
  "writerAnalysis.failedUnknown": { "ko-KR": "분석이 중단되었으며 사용량을 확인할 수 없습니다. 새 분석을 요청하지 않았습니다.", "ja-JP": "分析が停止し、使用量を確認できません。新しい分析は依頼していません。", "en-US": "Analysis stopped and usage could not be confirmed. No new analysis has been requested.", "zh-CN": "分析已停止，使用量无法确认。未请求新的分析。", "zh-Hant": "分析已停止，使用量無法確認。未請求新的分析。" },
  "writerAnalysis.structural": { "ko-KR": "구조 정보만 있는 결과입니다. 의미 분석 완료를 뜻하지 않습니다.", "ja-JP": "構造情報のみの結果です。意味分析の完了を示すものではありません。", "en-US": "These results contain structural information only, not a completed semantic analysis.", "zh-CN": "此结果仅含结构信息，不代表语义分析已完成。", "zh-Hant": "此結果僅含結構資訊，不代表語義分析已完成。" },
  "writerAnalysis.loadFailed": { "ko-KR": "최신 결과를 불러오지 못했습니다. 상태를 다시 확인해 주세요.", "ja-JP": "最新の結果を読み込めませんでした。状態を再確認してください。", "en-US": "The latest results could not be loaded. Check the status again.", "zh-CN": "无法加载最新结果。请重新查看状态。", "zh-Hant": "無法載入最新結果。請重新查看狀態。" },
  ...
  "writerAnalysis.pageCount": { "ko-KR": "{from}–{to} / {total}개", "ja-JP": "{from}–{to} / {total}件", "en-US": "{from}–{to} of {total}", "zh-CN": "第 {from}–{to} 项，共 {total} 项", "zh-Hant": "第 {from}–{to} 項，共 {total} 項" },
  "writerAnalysis.structure": { "ko-KR": "구조 정보", "ja-JP": "構造情報", "en-US": "Structural information", "zh-CN": "结构信息", "zh-Hant": "結構資訊" },
  "writerAnalysis.structureNote": { "ko-KR": "원고의 구조에서 확인한 항목입니다. 내용에 대한 해석이나 승인이 아닙니다.", "ja-JP": "原稿の構造から確認した項目です。内容の解釈や承認ではありません。", "en-US": "An item identified from manuscript structure, not an interpretation or approval of its content.", "zh-CN": "此项来自稿件结构，并非对内容的解读或批准。", "zh-Hant": "此項來自稿件結構，並非對內容的解讀或批准。" },
  "writerAnalysis.inference": { "ko-KR": "AI 해석 · 원문 대조 필요", "ja-JP": "AIによる解釈 · 原文との照合が必要", "en-US": "AI interpretation · check against the source", "zh-CN": "AI 解读 · 需对照原文", "zh-Hant": "AI 解讀 · 需對照原文" },
  "writerAnalysis.source": { "ko-KR": "인용 원문", "ja-JP": "引用元", "en-US": "Source quotations", "zh-CN": "原文引用", "zh-Hant": "原文引用" },
  "writerAnalysis.location": { "ko-KR": "파트 {part} · 문단 {paragraph}", "ja-JP": "パート {part} · 段落 {paragraph}", "en-US": "Part {part} · paragraph {paragraph}", "zh-CN": "部分 {part} · 段落 {paragraph}", "zh-Hant": "部分 {part} · 段落 {paragraph}" },
  "writerAnalysis.quoteFailed": { "ko-KR": "인용 원문을 확인하지 못했습니다. 인용 원문 버튼으로 다시 확인할 수 있습니다.", "ja-JP": "引用元を確認できませんでした。引用元ボタンで再確認できます。", "en-US": "The source quotation could not be verified. Use Source quotations to check again.", "zh-CN": "无法核实原文引用。可以再次选择原文引用来核对。", "zh-Hant": "無法核實原文引用。可以再次選擇原文引用來核對。" },
  "storyIntake.nav": {
    "ko-KR": "원고 접수",
    "ja-JP": "原稿受付",
