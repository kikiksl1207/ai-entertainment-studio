...
const I18N_DICT = {
  ...
  "writerManuscript.privacy": { "ko-KR": "이 입력은 이 브라우저에서만 확인하며 서버에 저장하지 않습니다. 작품명과 원고 본문은 접수 준비 중 공개되지 않습니다.", "ja-JP": "入力内容はこのブラウザー内でのみ確認し、サーバーには保存しません。作品名と本文は準備中に公開されません。", "en-US": "This draft stays in this browser and is not saved on the server. The work title and manuscript are not published during preparation.", "zh-CN": "输入内容仅在本浏览器中查看，不会保存到服务器。准备期间作品名称和正文不会公开。", "zh-Hant": "輸入內容僅在此瀏覽器中查看，不會儲存到伺服器。準備期間作品名稱和正文不會公開。" },
