...
const I18N_DICT = {
  ...
  "writerManuscript.privacy": { "ko-KR": "제출 전에는 이 브라우저에서만 검토합니다. 제출한 원고는 비공개로 접수되며 이 화면에서 공개하거나 분석하지 않습니다.", "ja-JP": "送信前はこのブラウザー内だけで確認します。送信した原稿は非公開で受け付け、この画面では公開も分析もしません。", "en-US": "Review stays in this browser until submission. Submitted manuscripts are received privately; this screen does not publish or analyze them.", "zh-CN": "提交前仅在此浏览器中核对。提交的稿件将以非公开方式接收；此页面不会发布或分析稿件。", "zh-Hant": "提交前僅在此瀏覽器中核對。提交的稿件會以非公開方式接收；此頁面不會發布或分析稿件。" },
