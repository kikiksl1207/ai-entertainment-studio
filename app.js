...
const I18N_DICT = {
  ...
  "writerAnalysis.reserved": { "ko-KR": "이 원고 버전에는 이미 분석 요청이 있습니다. 여기서는 해당 요청을 불러올 수 없습니다. 원고를 다시 제출할 필요는 없습니다.", "ja-JP": "この原稿バージョンには既に分析の依頼があります。ここではその依頼を読み込めません。原稿の再送信は不要です。", "en-US": "This manuscript version already has an analysis request, but it cannot be retrieved here. You do not need to resubmit the manuscript.", "zh-CN": "此稿件版本已有分析请求，但这里无法取回该请求。不需要重新提交稿件。", "zh-Hant": "此稿件版本已有分析請求，但這裡無法取回該請求。不需要重新提交稿件。" },
...
function normalizePublicDiscoveryNavigation() {
  ...
  document.querySelectorAll(".mobile-tabbar").forEach(tabbar => {
    tabbar.innerHTML = `
      <a href="/" class="mobile-tab" data-tab-key="index"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 11.5L12 4l9 7.5V20a1 1 0 0 1-1 1h-5v-6h-6v6H4a1 1 0 0 1-1-1z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/></svg><span>${t("tab.home")}</span></a>
      <a href="/characters" class="mobile-tab" data-tab-key="characters"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="3.2" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M4.5 20c.6-3.6 3.7-6 7.5-6s6.9 2.4 7.5 6" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg><span>${t("tab.artists")}</span></a>
      <a href="/story-stage" class="mobile-tab" data-tab-key="story"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 4.5h10.5A2.5 2.5 0 0 1 18 7v12.5H7.5A2.5 2.5 0 0 1 5 17z" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="M8 8h7M8 12h7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg><span>${t("tab.story")}</span></a>
      <a href="/ott" class="mobile-tab" data-tab-key="ott"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3.5" y="5" width="17" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="1.7"/><path d="m10 9 5 3-5 3z" fill="currentColor"/></svg><span>${t("tab.ott")}</span></a>
      <a href="/lumina-feed" class="mobile-tab" data-tab-key="lumina-feed"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16v10H7l-3 3z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/></svg><span>${t("tab.feed")}</span></a>`;
  });
}
