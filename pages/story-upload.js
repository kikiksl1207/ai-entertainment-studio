(function initStoryUploadPage() {
  ...
  const aiFallbackEvidence = {
    ...
    fallbackReasonCopy: "Writer ending is missing for this branch.",
        ...
        <section class="su-grid">
          ...
          <div class="su-section">
            ...
            <dl class="su-ai-fallback-evidence"
              ...
              <dd>${escapeHtml(aiFallbackEvidence.branch)} · Writer ending missing only · ${escapeHtml(aiFallbackEvidence.fallbackReasonCopy)}</dd>
