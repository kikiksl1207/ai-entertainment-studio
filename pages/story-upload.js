(function initStoryUploadPage() {
  ...
  const UI = {
    ...
    en: {
      ...
      preview: {
        ...
        aiCriteriaTitle: "Helper draft candidate rules",
        ...
        mainRouteBadgeBody: "One representative ending is fixed separately from helper drafts.",
  ...
  const QA_COPY = {
    ko: {
      ...
      choices: [
        ...
        { label: "C", tone: "ending", text: "해안으로 우회한다", next: "안개 해안 우회", result: "관계 변화 + 보류 후보 조건", rejoin: "보조 초안 후보", tags: ["관계", "보류"] },
      ],
      endings: ["작가 기본 엔딩", "작가 보조 엔딩", "보조 초안 후보"],
      endingCards: [
        { type: "author_main", title: "작가 기본 엔딩", body: "작가가 지정한 중심 루트의 결말이에요." },
        { type: "author_sub", title: "작가 보조 엔딩", body: "작가가 별도로 준비한 선택 루트 결말이에요." },
        { type: "ai", title: "보조 초안 후보", body: "작가 엔딩이 없는 분기에서만 보류 후보로 보여요. 공식 결말처럼 보이지 않게 검수 대기 상태를 유지합니다." },
      ],
    },
    en: {
      ...
      aiFallbackEvidence: {
        title: "Helper draft candidate note",
      ...
      endingLabels: {
        ...
        ai_fallback: "Helper draft candidate",
      },
      ...
      choices: [
        ...
        { label: "C", tone: "ending", text: "Detour to the shore", next: "Foggy shore detour", result: "Relation shift + pending draft rule", rejoin: "Helper draft candidate", tags: ["Relation", "Pending"] },
      ],
      endings: ["Writer primary ending", "Writer side ending", "Helper draft candidate"],
      endingCards: [
        ...
        { type: "ai", title: "Helper draft candidate", body: "A pending draft candidate shown only for branches without writer endings, never as an official ending." },
      ],
    },
    ja: {
      planTitle: "パート/分岐基準",
      ...
      choices: [
        ...
        { label: "C", tone: "ending", text: "海岸へ迂回する", next: "霧の海岸迂回", result: "関係変化 + 保留候補条件", rejoin: "補助下書き候補", tags: ["関係", "保留"] },
      ],
      endings: ["作家基本終了", "作家サブ終了", "補助下書き候補"],
      endingCards: [
        { type: "author_main", title: "作家基本終了", body: "作家が指定した中心ルートの結末です。" },
        { type: "author_sub", title: "作家サブ終了", body: "作家が別途用意した選択ルートの結末です。" },
        { type: "ai", title: "補助下書き候補", body: "作家終了がない分岐だけに保留候補として表示され、公式終了には見せません。" },
      ],
    },
    "zh-Hans": {
      planTitle: "分部/分支标准",
      ...
      choices: [
        ...
        { label: "C", tone: "ending", text: "绕到海岸", next: "雾中海岸绕行", result: "关系变化 + 待定候选条件", rejoin: "辅助草稿候选", tags: ["关系", "待定"] },
      ],
      endings: ["作者主线结局", "作者支线结局", "辅助草稿候选"],
      endingCards: [
        { type: "author_main", title: "作者主线结局", body: "作者指定的主路线结局。" },
        { type: "author_sub", title: "作者支线结局", body: "作者另外准备的选择路线结局。" },
        { type: "ai", title: "辅助草稿候选", body: "只在没有作者结局的分支中作为待定候选显示，不会显示成正式结局。" },
      ],
    },
    "zh-Hant": {
      planTitle: "分部/分支標準",
      ...
      choices: [
        ...
        { label: "C", tone: "ending", text: "繞到海岸", next: "霧中海岸繞行", result: "關係變化 + 待定候選條件", rejoin: "輔助草稿候選", tags: ["關係", "待定"] },
      ],
      endings: ["作者主線結局", "作者支線結局", "輔助草稿候選"],
      endingCards: [
        { type: "author_main", title: "作者主線結局", body: "作者指定的主路線結局。" },
        { type: "author_sub", title: "作者支線結局", body: "作者另外準備的選擇路線結局。" },
        { type: "ai", title: "輔助草稿候選", body: "只在沒有作者結局的分支中作為待定候選顯示，不會顯示成正式結局。" },
      ],
    },
  };
  ...
  const AUTHOR_PREVIEW_FIXTURE = {
    ...
    endings: [
      ...
      {
        label: { ko: "보조 초안 후보", en: "Helper draft candidate", ja: "補助下書き候補", "zh-Hans": "辅助草稿候选", "zh-Hant": "輔助草稿候選" },
        count: "1",
  ...
  const CREATOR_BRIDGE_COPY = {
    ...
    en: {
      ...
      candidateOnly: "Bulk routes stay as reference candidates",
