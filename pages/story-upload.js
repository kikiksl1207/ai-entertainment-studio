(function initStoryUploadPage() {
  ...
  const COPY = {
    ko: {
      ...
      rightsReferencePlaceholder: "계약명 또는 확인 가능한 내부 자료명을 입력해 주세요",
      manuscript: "최종 원고",
      ...
      serviceUnavailable: "최종 원고 접수 서버가 아직 연결되지 않았습니다.",
    ...
    en: {
      ...
      rightsReferencePlaceholder: "Enter the contract or internal reference name",
      ...
      serviceUnavailable: "The final manuscript intake server is not connected yet.",
    ...
    ja: {
      ...
      rightsReferencePlaceholder: "契約名または社内資料名を入力してください",
      manuscript: "最終原稿",
      manuscriptAccept: "MD, TXT, DOCX, PDF, JSON",
      ...
      serviceUnavailable: "最終原稿受付サーバーはまだ接続されていません。",
    ...
    "zh-Hans": {
      ...
      rightsReferencePlaceholder: "请输入合同名或内部资料名",
      manuscript: "最终原稿",
      manuscriptAccept: "MD, TXT, DOCX, PDF, JSON",
      metadata: "分支与结局资料",
      ...
      serviceUnavailable: "最终原稿接收服务器尚未连接。",
      submitted: "最终原稿已提交。",
    ...
    "zh-Hant": {
      ...
      rightsReferencePlaceholder: "請輸入合約名或內部資料名",
      manuscript: "最終原稿",
      manuscriptAccept: "MD, TXT, DOCX, PDF, JSON",
      metadata: "分支與結局資料",
      metadataAccept: "JSON或CSV",
      ...
      serviceUnavailable: "最終原稿接收伺服器尚未連接。",
      submitted: "最終原稿已提交。",
