...
task: "#414 Lumina Feed 2200-character server contract"
branch: team2-backend/lumina-feed-2200-contract-414
...
- git diff --check
result:
- Raised regular Lumina Feed post body, post body edit, and quote repost body validation to 2200 characters.
...
blocked_by:
- Frontend should align its compose/edit/quote counters and copy before deployment.
