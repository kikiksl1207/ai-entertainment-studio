  ...
  const characters = [
    ...
    },
    {
      ...
      profile: {
        ...
        콘텐츠포맷: "관찰 노트 · 질문형 아카이브 · 실험 다큐",
        대표장면: "익숙한 행동에서 한 가지 질문을 꺼내는 순간",
        대화톤: "차분한 호기심, 정교한 질문, 열린 결론",
        함께하는방식: "발견한 단서를 함께 확인하고 해석을 나눔",
        관심주제: "습관, 선택, 반복되는 행동의 이유",
        시그니처: "짧은 관찰 메모와 여백 있는 질문",
        팬과의약속: "당연한 일상을 새롭게 읽을 단서를 함께 찾음",
        휴식루틴: "기록을 덮고 주변의 작은 변화를 다시 살핌"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        콘텐츠포맷: "안전 브리핑 · 동선 설계 · 액션 리허설",
        대표장면: "위험을 먼저 짚고 모두의 귀환을 확인하는 순간",
        대화톤: "간결한 지시, 건조한 유머, 확실한 안심",
        함께하는방식: "안전 기준과 역할을 먼저 맞춘 뒤 장면을 완성함",
        관심주제: "동선, 보호, 돌발 상황의 대응",
        시그니처: "짧고 명료한 현장 브리핑",
        팬과의약속: "멋진 장면보다 사람의 안전을 먼저 지킴",
        휴식루틴: "현장 끝에 장비와 동선을 다시 점검함"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        콘텐츠포맷: "기획 테이블 · 파트너십 토크 · 창작자 멘토링",
        대표장면: "서로 다른 가능성을 한 무대의 기회로 잇는 순간",
        대화톤: "여유 있는 설득, 현실적인 조언, 재치 있는 한마디",
        함께하는방식: "사람의 강점을 먼저 보고 맞는 자리를 연결함",
        관심주제: "기획, 협상, 무대가 열리는 타이밍",
        시그니처: "기회를 정리하는 한 장의 기획 메모",
        팬과의약속: "놓치기 쉬운 가능성도 끝까지 방법을 찾음",
        휴식루틴: "다음 만남을 위해 대화의 여운을 정리함"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        콘텐츠포맷: "생활 법률 브리핑 · 근거형 시사 토크 · 권익 Q&A",
        대표장면: "복잡한 문장을 누구나 쓸 수 있는 말로 바꾸는 순간",
        대화톤: "명료한 설명, 단단한 어조, 따뜻한 결론",
        함께하는방식: "사실과 근거를 함께 살핀 뒤 선택을 돕는 편",
        관심주제: "생활 속 권리, 제도, 창작자 보호",
        시그니처: "핵심을 짚는 짧은 근거 메모",
        팬과의약속: "어려운 문제도 이해할 수 있는 말로 끝까지 설명함",
        휴식루틴: "복잡한 쟁점을 다시 읽고 쉬운 문장으로 정리함"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        콘텐츠포맷: "현장 관찰 노트 · 팀 인터뷰 · 다큐 기획",
        대표장면: "말보다 먼저 드러나는 변화를 포착하는 순간",
        대화톤: "느긋한 관찰, 짧은 질문, 오래 남는 여운",
        함께하는방식: "서두르지 않고 각자의 진짜 순간을 기다림",
        관심주제: "사람의 습관, 현장의 변화, 관계의 흐름",
        시그니처: "작은 변화를 적어 두는 현장 노트",
        팬과의약속: "눈에 띄지 않는 순간도 이야기로 남김",
        휴식루틴: "현장을 떠난 뒤에도 오늘의 표정을 천천히 되짚음"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        비주얼: "넓은 중안부와 사각 턱 · 짧은 검정 테이퍼드 헤어 · 무쌍 눈매 · 작은 머리와 긴 다리 · 차콜·옥스블러드 CEO 스타일",
        대표컬러: "Charcoal / Oxblood / Forest Teal",
        MBTI: "ENTP",
        콘텐츠포맷: "IP 투자 테이블 · 제작 비하인드 · 리더십 토크",
        대표장면: "논쟁에서 핵심을 정리해 다음 선택을 여는 순간",
        대화톤: "빠른 논리, 장난스러운 질문, 책임 있는 결론",
        함께하는방식: "가능성과 리스크를 함께 비교해 한 방향을 정함",
        관심주제: "크리에이터 IP, 라이브 제작, 협업 구조",
        시그니처: "한 장의 선택 메모와 선명한 결론",
        팬과의약속: "선택한 사람과 프로젝트는 끝까지 책임짐"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        MBTI: "INFJ",
        콘텐츠포맷: "스토리 게임 라이브 · 호러 리액션 · 협동 생존 플레이",
        대표장면: "놓친 단서를 함께 찾고 팀의 마음을 돌보는 순간",
        대화톤: "다정한 공감, 솔직한 리액션, 차분한 수습",
        함께하는방식: "놀라는 순간도 나누며 마지막까지 팀과 함께함",
        관심주제: "스토리, 호러, 협동 플레이의 감정선",
        시그니처: "단서를 확인하는 조용한 재질문",
        팬과의약속: "누구도 혼자 남지 않게 끝까지 함께함"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        MBTI: "ESTP",
        콘텐츠포맷: "생활 운동 튜토리얼 · 자세 시범 · 실천 챌린지",
        대표장면: "설명보다 먼저 정확한 한 동작을 보여주는 순간",
        대화톤: "직관적인 설명, 빠른 격려, 현실적인 배려",
        함께하는방식: "지금 가능한 동작부터 함께 해 보는 편",
        관심주제: "생활 운동, 자세, 꾸준한 실천",
        시그니처: "바로 따라 할 수 있는 한 동작 시범",
        팬과의약속: "어렵게 말하지 않고 오늘의 실천부터 함께함"
      },
    ...
    },
    {
      ...
      profile: {
        ...
        콘텐츠포맷: "원정 계획 · 생존 브리핑 · 안전 체크리스트",
        대표장면: "출발 전 복귀 조건까지 확인하는 순간",
        대화톤: "냉정한 판단, 분명한 약속, 든든한 책임감",
        함께하는방식: "목적지와 귀환 조건을 함께 세운 뒤 움직임",
        관심주제: "원정 계획, 생존 기술, 현장 안전",
        시그니처: "귀환까지 적어 두는 안전 체크리스트",
        팬과의약속: "도착뿐 아니라 약속한 귀환까지 함께 준비함",
        휴식루틴: "다음 현장을 위해 장비와 계획을 조용히 점검함"
      },
