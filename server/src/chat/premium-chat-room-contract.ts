...
export const PREMIUM_CHAT_ROOM_ACCESS_PROJECTION_CONTRACT = {
  ...
  sourceTables: {
    ...
    artists: 'artists',
    artistProfiles: 'artist_public_profiles',
    latestMessageSummary: 'premium_chat_room_latest_safe_message_projection',
  },
  accessControl: {
    authRequired: true,
    ownershipSource: 'premium_chat_rooms.owner_user_id',
  ...
  artistProfileLink: {
    ...
    displayNameSource: 'artists.display_name',
    avatarSource: 'artist_public_profiles.avatar_url',
  ...
  copyPolicy: {
    ...
    expiredStateKey: 'chat.premiumRoom.expired',
    activeStateKey: 'chat.premiumRoom.active',
  },
  privacy: {
    rawChatBodyReturned: false,
    rawUserEmailReturned: false,
...
export const PREMIUM_CHAT_ROOM_CONTRACT = {
  ...
  roomAccessProjection: PREMIUM_CHAT_ROOM_ACCESS_PROJECTION_CONTRACT,
  responsePolicy: {
