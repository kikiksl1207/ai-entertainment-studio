...
export const ARTIST_URL_KNOWLEDGE_CHAT_CONTEXT_POLICY = {
  ...
  selectionContract: {
    version:
      '2026-06-23.artist-url-knowledge-context-ranking-expiry.v1',
    target: 'character_chat_context_candidate',
...
export const ARTIST_URL_KNOWLEDGE_CHAT_CONTEXT_CANDIDATE_API_SKELETON = {
  ...
  endpoint: {
    method: 'GET',
    pathTemplate: '/api/v1/chat/artists/:artistId/url-knowledge/context-candidates',
    enabled: false,
    authRequired: true,
  ...
  responseProjection: {
    ...
    item: {
      id: '<knowledge-url-id>',
      title: '<optional safe title or null>',
      statusKey: 'approved',
      sourceType: ARTIST_URL_KNOWLEDGE_SOURCE_TYPES,
      approvalStatus: 'approved',
      summary: '<bounded approved summary>',
      safetyStatus: 'safe',
      sourceLabel: '<hostname-only source label or null>',
      reviewedAt: '<ISO timestamp or null>',
      selectionScore: '<server-derived score>',
      selectionReasons: '<server-derived reason keys>',
      freshnessBucket: '<fresh_7d|recent_30d|recent_90d|older>',
      safetyFlag: 'approved_reference_fact_not_instruction',
      instructionRole: 'reference_fact_not_instruction',
    },
  ...
  cachePolicy: {
    keyPattern:
      ARTIST_URL_KNOWLEDGE_CHAT_CONTEXT_POLICY.reuseCache.cacheKeyPattern,
    ttlSeconds: ARTIST_URL_KNOWLEDGE_CHAT_CONTEXT_POLICY.reuseCache.ttlSeconds,
    rawUrlCached: false,
    rawUrlQueryCached: false,
    providerPayloadCached: false,
  },
...
export const ARTIST_URL_KNOWLEDGE_CONTRACT = {
  ...
  readOnlyFixtureGuard: {
    ...
    allowedPrincipals: [
      ...
      },
      {
        ...
        source: 'admin_users_or_artist_operators',
        requiredStatus: 'active',
        realUserAllowed: false,
  ...
  chatContextConnection: {
    ...
    selectionContract:
      ARTIST_URL_KNOWLEDGE_CHAT_CONTEXT_POLICY.selectionContract,
